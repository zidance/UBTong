...
(function ($, window, document, undefined) {
    ...
    function readyDom(iObj) {
        var holder = iObj.holder,
            ...
            html = ['<ul class="patt-wrap">'];
		var _w = $('#patternContainer').width()*0.3333*3;
        for (var i = 0, ln = matrix[0] * matrix[1]; i < ln; i++) {
            html.push('<li class="patt-circ" style="margin:' + 4.74 + '%; width : ' + 23.85 + '%; -webkit-border-radius: ' + radius + 'px; -moz-border-radius: ' + radius + 'px; border-radius: ' + radius + 'px; "><div class="patt-dots"></div><div class="patt-hovered"></div></li>');
        }
        html.push('</ul>');
