      ...
      var iPageNum = 0, //第n个页面
        ...
        errors = {
          ...
          pageError: function () { //路径错误
            ...
            //            errors.page[errors.page.length] = iPageNum
      ...
      function exportError() {
        ...
        setTimeout(function () {
          ...
          if (errors.hasError) {
            ...
            $$(".pgErrorInfo").css("display", "block").next().css("display", "block")

            $$(".pgErrorInfoPath").css("display", "block")

            //      var errorPage=''
            ////      alert(typeof errors.page)
            //      for(var i in errors.page){
            //        
            //        alert(errors.page[i])
            //      }
            //     
